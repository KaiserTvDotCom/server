...
def enviarMensaje(msg):
       for chatID in listaChats:
                bot.send_message(chatID,msg)

#Ruta para alertas
#ref = db.reference('/Alerts').order_by_child("imei").equal_to(869951035674344)
# Fecha actual
...
for empresa in listaEmpresas:
        ...
        for vehiculo,imeis in listaVehiculos.items():
                ...
                if(abs(subidaCounter-bajadaCounter)<limitePasajes):
                        ...
                        enviarMensaje('conteos incorrectos en Unidad:'+ vehiculo  + mensajeUnificado)
                        errorConteos=True

        print('TERMINO RUTA: ',nombre)

if not errorConteos:
        enviarMensaje('Conteos en rutas OK')
